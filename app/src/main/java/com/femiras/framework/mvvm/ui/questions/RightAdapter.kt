...
import kotlinx.android.synthetic.main.layout_right.view.*


import kotlinx.android.synthetic.main.layout_second.view.*
import kotlinx.android.synthetic.main.layout_second.view.icon

class RightAdapter (val context: Context) : RecyclerView.Adapter<RightAdapter
.CustomViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        val inflater = LayoutInflater.from(parent?.context)
        val cellForRow = inflater.inflate(R.layout.layout_right, parent, false)
