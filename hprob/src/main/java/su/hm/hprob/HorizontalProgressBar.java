...
public class HorizontalProgressBar extends View {
    ...
    private static final int DEF = Color.parseColor("#F6F5F5");
    private static final int DEF_COLOR = Color.parseColor("#D3D1D1");
    private int DEF_SECONDARY_COLOR = Color.parseColor("#00796B");
    private int SELECT_SECONDARY_COLOR = Color.parseColor("#00BCD4");
    private int SELECT_COLOR = Color.parseColor("#78DDEA");
    private static final int DEF_TEXT_COLOR =Color.parseColor("#C0C0C0");
    ...
    private  int  evan=Color.RED;
    private  int  khan=Color.RED;
    private String akh="TEST";
    ...
    public void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.HprobAttrs, defStyleAttr, defStyleRes);
        ...
        textColor = a.getColor(R.styleable.HprobAttrs_text_color, Color.RED);
    ...
    public void test(int a,String data){
        if(a==0){
            evan=SELECT_SECONDARY_COLOR;
            khan=SELECT_COLOR;
...
//        }
    ...
    private void drawText(Canvas canvas) {
        ...
        // draw text
        canvas.drawText(akh, 16, y, textPaint);
        canvas.drawText(percentVal, 756, y, textPaint);
    }
